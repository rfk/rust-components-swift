...
private extension RustBuffer {
    ...
    init(bytes: [UInt8]) {
        let rbuf = bytes.withUnsafeBufferPointer { ptr in
            try! rustCall(UniffiInternalError.unknown("RustBuffer.init")) { err in
                ffi_crashtest_cabf_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), err)
            }
        }
    ...
    func deallocate() {
        try! rustCall(UniffiInternalError.unknown("RustBuffer.deallocate")) { err in
            ffi_crashtest_cabf_rustbuffer_free(self, err)
        }
    }
}
    ...
    fileprivate static func lift(_ v: FfiType) throws -> Self {
        defer {
            try! rustCall(UniffiInternalError.unknown("String.lift")) { err in
                ffi_crashtest_cabf_rustbuffer_free(v, err)
            }
        }
        if v.data == nil {
            return String()
        ...
        return utf8CString.withUnsafeBufferPointer { ptr in
            ...
            ptr.withMemoryRebound(to: UInt8.self) { ptr in
                ...
                return try! rustCall(UniffiInternalError.unknown("String.lower")) { err in
                    ffi_crashtest_cabf_rustbuffer_from_bytes(bytes, err)
                }
            }
        }
    }
        ...
        defer {
            if message != nil {
                try! rustCall(UniffiInternalError.unknown("UniffiInternalError.fromConsuming")) { err in
                    ffi_crashtest_cabf_string_free(message!, err)
                }
            }
        }
...
public enum CrashTestError: RustError {
    case NoError
    ...
    public var errorDescription: String? {
        ...
        case let .ErrorFromTheRustCode(message):
            return "CrashTestError.ErrorFromTheRustCode: \(message)"
    ...
    fileprivate static func fromConsuming(_ rustError: NativeRustError) throws -> Self? {
        ...
        defer {
            if message != nil {
                try! rustCall(UniffiInternalError.unknown("CrashTestError.fromConsuming")) { err in
                    ffi_crashtest_cabf_string_free(message!, err)
                }
            }
        }
        ...
        case 1:
            return .ErrorFromTheRustCode(message: String(cString: message!))
...
public func triggerRustAbort() {
    try! rustCall(
        ...
        crashtest_cabf_trigger_rust_abort(err)
    }
}
...
public func triggerRustPanic() {
    try! rustCall(
        ...
        crashtest_cabf_trigger_rust_panic(err)
    }
}

public func triggerRustError() throws {
    try rustCall(
        CrashTestError.NoError

    ) { err in
        crashtest_cabf_trigger_rust_error(err)
    }
}
